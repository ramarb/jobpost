...
INSERT INTO `job_categories` VALUES (1,'Account Manager',2),(2,'Banking And Finace',2),(3,'Software Engineers',1),(4,'Software Tester',1),(5,'Quality Assurance Engineers',1),(6,'System Administrator',1),(7,'Programmers',1);
...
INSERT INTO `job_industries` VALUES (1,'Information Technology'),(2,'Commerce'),(3,'Maritime Eng');
...
INSERT INTO `user_profiles` VALUES (1,1,'ramon','abar',NULL,NULL),(2,2,'ramon','abar',NULL,NULL),(3,3,'Ramonito','Abarquez',NULL,NULL),(4,4,'Eugene','Abao',NULL,NULL),(5,5,'Ramonito','Abarquez',NULL,NULL),(6,6,'Christine','Ecote',NULL,NULL),(7,7,'Dione','Abarquez',NULL,NULL),(8,8,'Gleigh','Ecot',NULL,NULL),(9,10,'Jones','Law',NULL,NULL),(10,11,'Rob','Clasby',NULL,NULL),(11,12,'Eugene','Abarquez',NULL,NULL);
...
INSERT INTO `user_roles` VALUES (1,1,1),(2,2,1),(3,3,4),(4,4,3),(5,5,4),(6,6,4),(7,7,2),(8,8,3),(9,10,3),(10,11,2),(11,12,2);
...
--
-- Dumping routines for database 'job_board'
--
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_industry_create`(
	IN p_name VARCHAR(255),
	OUT alert_message TEXT,
	OUT return_id INT
)
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_industry_update`(
	IN p_id INT,
	IN p_name VARCHAR(255),
	OUT alert_message TEXT,
	OUT return_id INT
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_vacancy_create`(
...
-- Dump completed on 2015-07-17 16:18:26
