...
INSERT INTO `user_files` VALUES (1,1,1,1,1),(2,3,2,2,4),(3,3,3,2,5),(4,3,3,2,6),(5,3,3,2,7),(6,3,3,2,8),(7,14,1,1,9),(8,14,1,1,11),(9,14,1,1,12),(10,14,1,1,13),(11,14,1,1,14),(12,14,1,1,15),(13,14,1,1,16),(14,8,2,1,17),(15,14,2,1,18);
...
INSERT INTO `user_roles` VALUES (1,1,1),(2,2,3),(3,3,4),(4,4,3),(5,5,4),(6,6,4),(7,7,2),(8,8,3),(9,10,3),(10,11,2),(11,12,3),(12,13,3),(13,14,4),(14,15,4);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ALLOW_INVALID_DATES,ERROR_FOR_DIVISION_BY_ZERO,TRADITIONAL,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_set_primary_work_experience`(
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ALLOW_INVALID_DATES,ERROR_FOR_DIVISION_BY_ZERO,TRADITIONAL,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_user_files_create`(
	IN p_users_id INT,
	IN p_location TEXT,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,STRICT_ALL_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ALLOW_INVALID_DATES,ERROR_FOR_DIVISION_BY_ZERO,TRADITIONAL,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_vacancy_applicant_create`(
...
-- Dump completed on 2016-10-27 16:18:13
