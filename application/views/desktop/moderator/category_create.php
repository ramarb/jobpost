...
<?php if($alert_type != 'Success'):?>
		...
		<div class="col-md-10">
		    <form class="form-horizontal" action="<?php echo base_url($role . '/'.$this->uri->segment(2).'/validate_create')?>" method="post">
		        ...
		        <div class="form-group">
		            ...
		            <div class="col-sm-6">
		                <input type="text" class="form-control" name="category" id="inputEmail3" value="<?php echo set_value('category') ?>" placeholder="">
		            </div>
		        </div>
	...
	var industry_id = '<?php echo set_value('industry_id') ?>';
